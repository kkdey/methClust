...
which we solve to estimate $\omeag^{(0)}$.
...
```{r eval=TRUE, warning=FALSE, fig.align="center", fig.show="asis", dpi=144, fig.width=5, fig.height=7, out.width="5in", out.height="7in"}
